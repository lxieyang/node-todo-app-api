...
describe('GET /todos/:id', () => {
  ...
  it('should not return todo doc created by other user', (done) => {
    request(app)
      .get(`/todos/${todosList[1]._id.toHexString()}`)  // try to get the second user's todo
      .set('x-auth', usersList[0].tokens[0].token)  // auth as the first user
      .expect(404)
      .end(done);
  });
...
describe('DELETE /todos/:id', () => {
  it('should remove a todo', (done) => {
    var hexId = todosList[1]._id.toHexString();   // owned by the second user

    request(app)
      .delete(`/todos/${hexId}`)
      .set('x-auth', usersList[1].tokens[0].token)  // auth as the second user
      .expect(200)
      .expect((res) => {
  ...
  it('should not remove a todo not created by you', (done) => {
    var hexId = todosList[0]._id.toHexString();   // owned by the first user
...
describe('PATCH /todos/:id', () => {
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    var hexId = todosList[1]._id.toHexString();
    var text = 'This should be the new text';
